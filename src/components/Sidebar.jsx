const Sidebar = () => {
    return (
        <div>
            <aside class="lg:absolute xl:absolute md:absolute flex flex-row lg:flex-col md:flex-col xl:flex-col w-full lg:w-64 md:w-60 xl:w-64 lg:h-screen md:h-screen xl:h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
